...
enum class ChainHeight
{
    ...
    H9a  // Generate 1B COLX, single testnet payment in the super block
};

/**
 * CChainParams defines various tweakable parameters of a given instance of the
 * ColossusXT system. There are three: the main network on which people trade goods
...
public:
    ...
    bool RequireNonFinal() const { return fRequireNonFinal; }
    int RequireNonFinalThreshold() const { return nRequireNonFinalThreshold; }
    ...
    virtual CBitcoinAddress Get1BAddress() const = 0;
...
protected:
    ...
    bool fRequireNonFinal;
    int nRequireNonFinalThreshold;
