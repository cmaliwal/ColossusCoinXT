...
void PrivacyDialog::on_pushButtonMintzPIV_clicked()
{
    ...
    for (CDeterministicMint dMint : vMints) {
        ...
        libzerocoin::CoinDenomination denom = dMint.GetDenomination();
        ...
        for (auto& meta : vMintsToFetch) {
            if (meta.nVersion < libzerocoin::PrivateCoin::PUBKEY_VERSION) {
                ...
                if (nSecurityLevel < 100) {
                    QMessageBox::warning(this, tr("Spend Zerocoin"), tr("Version 1 zCOLX require a security level of 100 to successfully spend."), QMessageBox::Ok, QMessageBox::Ok);
                    ui->TEMintStatus->setPlainText(tr("Failed to spend zCOLX"));
                    ui->TEMintStatus->repaint();
                    return;
                }
            }
...
{
    // ZCFIXTODO: turned off to compile, qt needs more syncing, this doesn't exist
    // if (fMinimize) {
                               ...
                               const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // ZCFIXTODO: turned off to compile, qt needs more syncing, this doesn't exist
    // ui->labelzAvailableAmount_4->setText(QString::number(zerocoinBalance/COIN) + QString(" zCOLX "));
    ...
    // ZCFIXTODO: turned off to compile, qt needs more syncing, this doesn't exist
    // ui->labelZsupplyAmount_2->setText(QString::number(chainActive.Tip()->GetZerocoinSupply()/COIN) + QString(" <b>zCOLX </b> "));
...
void PrivacyDialog::updateSPORK16Status()
{
    ...
    if (fMaintenanceMode && fButtonsEnabled) {
        ...
        ui->pushButtonMintzPIV->setToolTip(tr("PrivacyDialog", "Enter an amount of PIV to convert to zCOLX", 0));
