...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
    case TransactionRecord::MNReward:
        return QIcon(GUIUtil::getIconPath("tx_mined"));
    case TransactionRecord::RecvWithObfuscation:
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
    case TransactionRecord::RecvFromZerocoinSpend:
        return QIcon(GUIUtil::getIconPath("tx_input"));
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::ZerocoinSpend:
        return QIcon(GUIUtil::getIconPath("tx_output"));
    default:
        return QIcon(GUIUtil::getIconPath("tx_inout"));
    }
}
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionStatus::Confirming:
        ...
        case 1:
            return QIcon(GUIUtil::getIconPath("transaction_1"));
        case 2:
            return QIcon(GUIUtil::getIconPath("transaction_2"));
        case 3:
            return QIcon(GUIUtil::getIconPath("transaction_3"));
        case 4:
            return QIcon(GUIUtil::getIconPath("transaction_4"));
        default:
            return QIcon(GUIUtil::getIconPath("transaction_5"));
        };
    case TransactionStatus::Confirmed:
        return QIcon(GUIUtil::getIconPath("transaction_confirmed"));
    case TransactionStatus::Conflicted:
        return QIcon(GUIUtil::getIconPath("transaction_conflicted"));
    case TransactionStatus::Immature: {
        int total = wtx->status.depth + wtx->status.matures_in;
        int part = (wtx->status.depth * 4 / total) + 1;
        return QIcon(GUIUtil::getIconPath(QString("transaction_%1").arg(part)));
    }
    case TransactionStatus::MaturesWarning:
    case TransactionStatus::NotAccepted:
        return QIcon(GUIUtil::getIconPath("transaction_0"));
...
QVariant TransactionTableModel::txWatchonlyDecoration(const TransactionRecord* wtx) const
{
    if (wtx->involvesWatchAddress)
        return QIcon(GUIUtil::getIconPath("eye"));
    else
        return QVariant();
}
