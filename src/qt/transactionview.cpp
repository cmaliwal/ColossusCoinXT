    ...
    columnResizingFixer(0)
{
    ...
    watchOnlyWidget->addItem(QIcon(GUIUtil::getIconPath("eye_plus")), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(QIcon(GUIUtil::getIconPath("eye_minus")), "", TransactionFilterProxy::WatchOnlyFilter_No);
