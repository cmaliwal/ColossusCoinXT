...
namespace client
{
	...
	void I2PTunnelConnection::Connect (bool isUniqueLocal)
	{
		...
		if (m_Socket)
		{
			...
			LogPrint(eLogDebug, "I2PTunnelConnection: connecting...");
			LogPrint(eLogDebug, "I2PTunnelConnection: Address ", m_Stream->GetRemoteIdentity()->GetIdentHash().ToBase32(), " - connecting...");
	...
	{
		LogPrint(eLogDebug, "I2PTunnelConnection.Receive: Address ", m_Stream->GetRemoteIdentity()->GetIdentHash().ToBase32(), " - receiving...");
	...
	{
		LogPrint(eLogDebug, "I2PTunnelConnection.HandleReceived: Address ", m_Stream->GetRemoteIdentity()->GetIdentHash().ToBase32(), " - receiving...");
		if (ecode)
		{
	...
	{
		LogPrint(eLogDebug, "I2PTunnelConnection.HandleConnect: connected.");
		LogPrint(eLogDebug, "I2PTunnelConnection.HandleConnect: Address ", i2p::client::context.GetAddressBook().ToAddress(m_Stream->GetRemoteIdentity()->GetIdentHash()), " - connected.");
	...
	void I2PServerTunnel::HandleAccept (std::shared_ptr<i2p::stream::Stream> stream)
	{
		if (stream)
		{
			...
			LogPrint(eLogDebug, "I2PServerTunnel: Address ", stream->GetRemoteIdentity()->GetIdentHash().ToBase32(), " is now streaming...");
