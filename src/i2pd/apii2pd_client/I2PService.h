...
namespace client
{
    ...
    class I2PService : public std::enable_shared_from_this<I2PService>
    {
        ...
        public:
            ...
            virtual const char* GetDestination() { return "Generic Destination"; }
    ...
    //typedef std::function<void(const boost::system::error_code &)> ReadyCallback;
    //typedef std::function<void(std::shared_ptr<i2p::client::I2PPureTunnelConnection> connection)> ClientConnected;
    ...
    class I2PServiceHandler
    {
        ...
        public:
            ...
            //virtual void Handle(ClientConnected clientConnected = nullptr) {};
    ...
    class TCPIPAcceptor: public I2PService
    {
        ...
        protected:
            ...
            //{
            //    return CreateHandler(socket, nullptr);
            //};
    ...
    //class I2PServerTunnelBase : public I2PService
    //{
    //};
