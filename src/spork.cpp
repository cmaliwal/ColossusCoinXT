...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        //if (nSporkID == SPORK_16_ZEROCOIN_MAINTENANCE_MODE) r = SPORK_16_ZEROCOIN_MAINTENANCE_MODE_DEFAULT; // ZCTESTINGFIXES: 
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    //if (strName == "SPORK_16_ZEROCOIN_MAINTENANCE_MODE") return SPORK_16_ZEROCOIN_MAINTENANCE_MODE; // ZCTESTINGFIXES: 
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    //if (id == SPORK_16_ZEROCOIN_MAINTENANCE_MODE) return "SPORK_16_ZEROCOIN_MAINTENANCE_MODE"; // ZCTESTINGFIXES: 
