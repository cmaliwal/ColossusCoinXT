...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID ==  SPORK_21_ENFORCE_MIN_TX_FEE) r = SPORK_21_ENFORCE_MIN_TX_FEE_DEFAULT;
        if (nSporkID ==  SPORK_22_TX_FEE_VALUE) r = SPORK_22_TX_FEE_VALUE_DEFAULT;
        if (nSporkID ==  SPORK_23_LIMIT_BLOCK_TX) r = SPORK_23_LIMIT_BLOCK_TX_DEFAULT;
        if (nSporkID ==  SPORK_24_BLOCK_TX_VALUE) r = SPORK_24_BLOCK_TX_VALUE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_21_ENFORCE_MIN_TX_FEE") return SPORK_21_ENFORCE_MIN_TX_FEE;
    if (strName == "SPORK_22_TX_FEE_VALUE") return SPORK_22_TX_FEE_VALUE;
    if (strName == "SPORK_23_LIMIT_BLOCK_TX") return SPORK_23_LIMIT_BLOCK_TX;
    if (strName == "SPORK_24_BLOCK_TX_VALUE") return SPORK_24_BLOCK_TX_VALUE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id ==  SPORK_21_ENFORCE_MIN_TX_FEE) return "SPORK_21_ENFORCE_MIN_TX_FEE";
    if (id ==  SPORK_22_TX_FEE_VALUE) return "SPORK_22_TX_FEE_VALUE";
    if (id ==  SPORK_23_LIMIT_BLOCK_TX) return "SPORK_23_LIMIT_BLOCK_TX";
    if (id ==  SPORK_24_BLOCK_TX_VALUE) return "SPORK_24_BLOCK_TX_VALUE";
