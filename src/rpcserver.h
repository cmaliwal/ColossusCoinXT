...
extern UniValue getdestinations(const UniValue& params, bool fHelp);
extern UniValue getserverdestination(const UniValue& params, bool fHelp);
// extern UniValue testclienttunnel(const UniValue& params, bool fHelp);
